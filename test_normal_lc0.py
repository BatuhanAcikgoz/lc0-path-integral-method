#!/usr/bin/env python3
"""
Normal LC0 Test (Path Integral olmadan)
"""
...
def test_normal_lc0():
    """Normal LC0'ı test et"""
    lc0_path = "./builddir_normal/lc0"
    
    print("Normal LC0 motoru başlatılıyor...")
    ...
    try:
        ...
        if info.get('pv') and len(info['pv']) > 0:
            print(f"✅ Normal LC0 düzgün çalışıyor!")
            return True
        else:
            print(f"❌ Normal LC0 hamle döndürmüyor!")
            return False
